package com.example.PizzaOrden;
...
public class PizzaOrden {
    ...
    private String letraIngredienteAString(String letraIngrediente) {
        if (letraIngrediente.equals("a")) {
            return "Pimiento";
        } else if (letraIngrediente.equals("b")) {
            return "Hongos";
        } else if (letraIngrediente.equals("c")) {
            return "Espinaca";
        } else if (letraIngrediente.equals("d")) {
            return "Peperoni";
        } else if (letraIngrediente.equals("e")) {
            return "Jamon";
        } else if (letraIngrediente.equals("f")) {
            return "Salchicha";
        } else {
